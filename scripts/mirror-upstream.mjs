...
writeFileSync(
  join(out, "README.md"),
  "# upstream-mirror\n\nAuto-generated by `.github/workflows/mirror-upstream.yml` in nQuake/web-installer: the latest ezQuake, MVDSV and KTX release binaries, extracted, so the web installer can fetch them with CORS. Do not edit — the branch is force-pushed.\n",
);
